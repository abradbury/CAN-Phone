#	Based on the example makefile provided from the university.
...
OBJ		= serial.o can.o text.o keypad.o i2c.o lcd.o menu.o sevenseg.o dac.o music.o morse.o mysys.o
